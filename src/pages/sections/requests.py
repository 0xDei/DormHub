    ...
    def __init__(self, resident_page):
        ...
        header = ft.Row(
            [
                ...
                ) if self.resident_page.data["room_id"] != "N/A" else ft.Container()
            ]
        )
        ...
        if self.resident_page.data["room_id"] != "N/A":
            ...
            info_cards = ft.Container(ft.Text("You currently don't have a room", color=ft.Colors.BLACK), expand=True, alignment=ft.alignment.center)
            requests_list = ft.Container()
